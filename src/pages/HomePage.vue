		...
		<div class="flex flex-wrap mb-36">
			...
			<div class="w-full lg:w-1/2 self-end px-4">
				<div class="relative mt-10 lg:mt-0 lg:right-0">
					<img src="@/assets/images/anonymous.png" alt="Muhamad Haspin" class="max-w-full mx-auto" />
		...
		<div class="flex flex-wrap">
			...
			<div class="w-full lg:w-1/2 px-4">
				...
				<div class="flex items-center gap-3">
					...
					<!-- GitHub -->
					<a href="https://github.com/muhamadhaspin" target="_blank" class="border border-slate-300 hover:border-primary hover:bg-primary hover:text-white transition duration-300 w-9 h-9 rounded-full flex items-center justify-center">
						<svg width="20" class="fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							<title>GitHub</title>
							<path
					...
					<!-- Instagram -->
					<a href="https://instagram.com/mhmmdhdyh" target="_blank" class="border border-slate-300 hover:border-primary hover:bg-primary hover:text-white transition duration-300 w-9 h-9 rounded-full flex items-center justify-center">
						<svg width="20" class="fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
